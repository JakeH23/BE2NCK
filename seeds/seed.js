const { topicData, userData, articleData, commentData } = require('../db/data/development-data');
const { userLookup, formatArticles, articleLookup, formatComments } = require('../db/data/utils');
